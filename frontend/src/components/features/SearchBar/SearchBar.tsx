...
import { PROVINCES, DISTRICTS_BY_PROVINCE, ZONING_TYPES, BUILDING_TYPES } from "@/constants/locations";

const provinces = PROVINCES;
const districtsByProvince = DISTRICTS_BY_PROVINCE;
const zones = ZONING_TYPES;
